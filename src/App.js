    ...
    return (
      <div>
        ...
        <div>
          ...
          <img
            src="https://assets.ccbp.in/frontend/react-js/password-manager-password-manager-lg-img.png"
            alt="password manager"
          />
        </div>
        <div>
          <div>
            ...
            <div>
              <img
                src="https://assets.ccbp.in/frontend/react-js/password-manager-password-manager-search-img.png"
                alt="search"
              />
              <input
                type="search"
